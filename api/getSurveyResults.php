...
try {
    ...
    $stmt = $db->prepare("SELECT s.Title,s.Description,s.NumType1,s.NumType2,s.Type1Q,r.Type1A1,s.Type1Q2,r.Type1A2,s.Type1Q3,r.Type1A3,s.Type1Q4,r.Type1A4,s.Type1Q5,r.Type1A5,
